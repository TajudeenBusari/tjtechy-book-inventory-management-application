...
* and you need to convert to: @GeneratedValue(strategy = GenerationType.IDENTITY), use
* ALTER TABLE users ALTER COLUMN user_id ADD GENERATED BY DEFAULT AS IDENTITY; in the sql command
* */